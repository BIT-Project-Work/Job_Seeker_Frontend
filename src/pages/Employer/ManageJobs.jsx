                        ...
                        : paginatedJobs.map((job) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-5 whitespace-nowrap min-w-[120px] sm:min-w-0">
                              <span
                                className={`inline-flex px-3 py-1.5 text-sm font-semibold rounded-full ${job.status === "Active"
                            ...
                            <td className="px-6 py-5 whitespace-nowrap min-w-[130px] sm:win-w-0">
                              <button
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0">
                              <div className="flex space-x-2">
                                ...
                                {job.status === "Active" ? (
                                  <button
                                    className="flex items-center gap-2 text-xs text-orange-600 hover:text-orange-8000 p-2 rounded-lg hover:bg-orange-50 transition-colors duration-200 "
            ...
            {totalPages > 1 && (
              <div className="mt-6 flex items-center justify-between">
                <div className="flex-1 flex justify-between sm:hidden">
                  <button
                    className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-mg text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <button
                    className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-mg text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
